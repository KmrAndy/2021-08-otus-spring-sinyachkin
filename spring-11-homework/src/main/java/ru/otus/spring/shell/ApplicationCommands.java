...
public class ApplicationCommands {
    ...
    public String commentariesCount(Long bookId) {
        try {
            return messageService.getMessage(
    ...
    public String changeCommentaryTextByCommentaryId(Long id, String newText) {
        try {
    ...
    public String getCommentaryById(Long id) {
        try{
    ...
    public List<String> getBookCommentaries(Long bookId) {
        try{
    ...
    public String deleteByCommentaryId(Long id) {
        try{
