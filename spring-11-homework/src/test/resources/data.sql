...
insert into books(name, author_id, genre_id) values ('Anna Karenina', 2, 2);
insert into commentaries(book_id, text) values (1, 'Amazing');
insert into commentaries(book_id, text) values (1, 'Super');
insert into commentaries(book_id, text) values (2,'Boring');
insert into commentaries(book_id, text) values (3, 'Interesting');