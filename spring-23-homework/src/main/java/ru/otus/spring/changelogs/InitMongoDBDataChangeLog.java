...
public class InitMongoDBDataChangeLog {
    ...
    @ChangeSet(order = "005", id = "initUsers", author = "kmrandy", runAlways = true)
    public void initCommentaries(UserDetailsServiceCustom userDetailsService){
        userDetailsService.saveUser(new User("admin", "password"));
        userDetailsService.saveUser(new User("user", "qwerty"));
    }
}
